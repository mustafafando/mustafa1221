...
client.on("message", message => {
    if (message.content === (prefix + "help")) {
     const embed = new Discord.RichEmbed() 
         ...
         .setDescription(`** SYG اهلا وسهلا فيك في سيرفر 
		 ------------------------------
$invites 
| لمعرفة الاشخاص الذي دعوتهم		 **`)
   ...
   client.on("message", message => {
    if (message.content === (adminprefix + "help")) {
     const embed = new Discord.RichEmbed() 
         ...
         .setDescription(`** SYG اهلا وسهلا فيك في سيرفر 
		 ------------------------------
	1bc1 | لأرسال للجميع مع منشن للشخص

1bc2 | لأرسال رسالة للجميع بدون منشن 

1bcrole | لأرسال رسالة لرتبة محددة بعد كتابة الامر ضع علامة @ واسم الرتبة
	**`)
   message.author.sendEmbed(embed)
...
const devs = ["416567959067033601"]// ايدي الخاص بحسابك
...
client.on('message', message => {
  ...
  return message.reply("**تم تغيير الاسم :white_check_mark:**");
  } else
...
client.on('message', message => {
    ...
    if(message.content.includes('كس امك')){
      ...
      message.channel.sendMessage("", {embed: {
        title: "من شروط السيرفر",
        color: 0x06DF00,
        description: "`** ممنوع السب والا سوف يتم حظرك بشكل مباشر **`",
        footer: {
          text: "By SYG SERVER "
        }
...
client.on('message', message => {
    var args = message.content.split(/[ ]+/)
    if(message.content.includes('ابن شرموطة')){
        message.delete()
      message.channel.sendMessage("", {embed: {
        title: "من شروط السيرفر",
        color: 0x06DF00,
